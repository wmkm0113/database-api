...
public final class CalculateItem extends BaseItem {
	...
	/**
	 * <span class="en-US">Allowed parameter item types</span>
	 * <span class="zh-CN">允许的参数类型</span>
	 */
	...
	public CalculateItem() {
		...
		this.calculateParameters = new ArrayList<>();
	}
	 ...
	 * <h3 class="zh-CN">参与计算的查询项信息列表的 Getter 方法</h3>
	 *
	 ...
	 * <h3 class="zh-CN">参与计算的查询项信息列表的 Setter 方法</h3>
	 *
