...
public final class FromTable extends BaseFrom {
	 ...
	 */
	private static final long serialVersionUID = 6457816916995476473L;
	...
	/**
	 * <h3 class="en-US">Constructor method for the query from data table definition</h3>
	 * <h3 class="zh-CN">查询来源数据表定义的构造方法</h3>
	 */
	public FromTable() {
