	...
	public void simpleAndQuery() throws Exception {
		QueryInfo queryInfo =
				new QueryBuilder<>()
						...
						.betweenAnd("tableName", "columnName2").valueRange(5, 10).confirm()	//	Confirm condition
						.notBetweenAnd("tableName", "columnName2").valueRange(5, 10).confirm()	//	Confirm condition
						.in("tableName", "columnName3").inArray("a", "b", "c", "d", "e", "f").confirm()	//	Confirm condition
						.notIn("tableName", "columnName3").inArray("a", "b", "c", "d", "e", "f").confirm()	//	Confirm condition
						.similar("tableName", "columnName1").matchValue("%a").confirm()	//	Confirm condition
						.notSimilar("tableName", "columnName1").matchValue("%a").confirm()	//	Confirm condition
	...
	public void simpleOrQuery() throws Exception {
		QueryInfo queryInfo =
				new QueryBuilder<>()
						...
						.betweenAnd(ConnectionCode.OR, "tableName", "columnName2").valueRange(5, 10).confirm()
						.notBetweenAnd(ConnectionCode.OR, "tableName", "columnName2").valueRange(5, 10).confirm()
						.in(ConnectionCode.OR, "tableName", "columnName3").inArray("a", "b", "c", "d", "e", "f").confirm()
						.notIn(ConnectionCode.OR, "tableName", "columnName3").inArray("a", "b", "c", "d", "e", "f").confirm()
						.similar(ConnectionCode.OR, "tableName", "columnName1").matchValue("%a").confirm()
						.notSimilar(ConnectionCode.OR, "tableName", "columnName1").matchValue("%a").confirm()
	...
	public void simpleGroupQuery() throws Exception {
		QueryInfo queryInfo =
				new QueryBuilder<>()
						...
						.betweenAnd("tableName", "columnName2").valueRange(5, 10).confirm()
						.notBetweenAnd("tableName", "columnName2").valueRange(5, 10).confirm()
						.in("tableName", "columnName3").inArray("a", "b", "c", "d", "e", "f").confirm()
						.notIn("tableName", "columnName3").inArray("a", "b", "c", "d", "e", "f").confirm()
						.similar("tableName", "columnName1").matchValue("%a").confirm()
						.notSimilar("tableName", "columnName1").matchValue("%a").confirm()
						.isNull("tableName", "columnName1")
						.notNull("tableName", "columnName2")
